    ...
    return (
      <div className="min-h-screen text-white flex flex-col items-center justify-center p-4">
        <div className="flex items-center justify-center gap-6 mb-10">
          <h1 className="text-5xl md:text-7xl font-black tracking-widest text-amber-500 drop-shadow-[0_0_15px_rgba(245,158,11,0.5)]" style={{ fontFamily: '"Cinzel", "Montserrat", sans-serif' }}>MASQUERADE</h1>
          <img src="/favicon.png" alt="Masquerade Logo" className="w-16 h-16 md:w-24 md:h-24 object-contain drop-shadow-[0_0_15px_rgba(245,158,11,0.5)]" />
        </div>
  ...
  const rulesCard = (
    <div className="bg-slate-900 rounded-lg p-6 border border-slate-800 shadow-[0_0_20px_rgba(0,0,0,0.5)] h-full">
      ...
      <div className="space-y-4 text-sm text-slate-300 font-bold tracking-wide">
        ...
        <p><span className="text-amber-500">2.</span> Innocent payers know the Secret Word. The Impostor doesn't.</p>
